...
def argparser(is_train=True):
    ...
    parser.add_argument('--hdf5FileNametrain', type=str, default='train_MRIdata_3_AD_MCI_Normal.hdf5',
                        choices=['train_MRIdata_3_AD_MCI_Normal.hdf5','train_MRIdata_2_AD_MCI.hdf5', 'train_MRIdata_2_AD_Normal.hdf5', 'train_MRIdata_2_MCI_Normal.hdf5', 'train_MRIdata_3_AD_MCI_Normal.hdf5','data.hdf5'])
    parser.add_argument('--idFileNametrain', type=str, default='train_MRIdata_3_AD_MCI_Normal_id.txt',
                        choices=['train_MRIdata_3_AD_MCI_Normal_id.txt','train_MRIdata_2_AD_MCI_id.txt', 'train_MRIdata_2_AD_Normal_id.txt', 'train_MRIdata_2_MCI_Normal_id.txt',  'train_MRIdata_3_AD_MCI_Normal_id.txt','id.txt'])
