...
def construct_train_dir(config):
    ...
    config.prefix = '-10crossDepth{}_growthRate{}_reduce{}_model_type{}_keepPro{}'.format(
...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    dataset_train, dataset_test, all_hdf5_data = dataset.create_default_splits(dataset_path,config.hdf5FileName,config.idFileName,config.cross_validation_number)
    ...
    with open("./GANconfusionMatrixResults/allConfusionMatrix.txt", "w") as text_file:
        ...
        text_file.write(
            '{} 10 folds result to compute\n\nClassification Report\n\n{}\n\nConfusion Matrix\n\n{}\n'.format(
                config.hdf5FileName, cr, cm))
